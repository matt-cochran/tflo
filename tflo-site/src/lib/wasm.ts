...
export async function initWasm(): Promise<void> {
  ...
  initPromise = (async () => {
    try {
      // Dynamic import of the wasm glue code (generated by wasm-pack)
      // Use a relative path with a trailing slash to satisfy TypeScript
      // resolution while allowing Vite to serve from /wasm/ at runtime.
      const wasmUrl = new URL("/wasm/tflo.js", import.meta.url).href;
